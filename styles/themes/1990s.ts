...
const colors = {
  ...
  info: "#0000FF",
  logoFill: "#fff",
  logoPrimaryColor: "#0D8B8F",
  logoSecondaryColor: "#8B4C78",
  logoTertiaryColor: "#0A7A7D",
  imageBackgroundColor: "#5d2f4f",
} as const;
