...
const colors = {
  ...
  info: "#4D9FFF",
  logoFill: "#1D1010",
  logoPrimaryColor: "#D4A574",
  logoSecondaryColor: "#4A3A3B",
  logoTertiaryColor: "#2D1A1B",
...
export const daylightTheme: ThemeDefinition = {
  ...
  tokens: {
    ...
    fontFamilies: {
      ...baseFontFamilies,
      display: "Garabosse-Perle, serif",
      regular: "Garabosse-Parangon, sans-serif",
      semiBold: "Garabosse-Parangon, sans-serif",
      bold: "Garabosse-Perle, serif",
    },
    layout: baseLayout,
    shadows: {
      card: {
  ...
  assets: {
    logo: "/assets/images/midnight-logo.svg",
  },
};
