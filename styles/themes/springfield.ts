...
const colors = {
  ...
  info: "#8CA1C6",
  logoFill: "#2F2619",
  logoPrimaryColor: "#CC480F",
  logoSecondaryColor: "#C78C2C",
  logoTertiaryColor: "#9A9D27",
...
export const springfieldTheme: ThemeDefinition = {
  ...
  tokens: {
    ...
    fontFamilies: {
      ...baseFontFamilies,
      display: "OpenDyslexic-Bold, sans-serif",
      semiBold: "W95FA, sans-serif",
      bold: "W95FA, sans-serif",
    },
    layout: baseLayout,
    shadows: {
      card: {
  ...
  assets: {
    logo: "/assets/images/springfield-logo.svg",
  },
};
