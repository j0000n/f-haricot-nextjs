...
const colors = {
  ...
  info: "#6C9BFF",
  logoFill: "#F8F6FF",
  logoPrimaryColor: "#cc0202",
  logoSecondaryColor: "#6C9BFF",
  logoTertiaryColor: "#6BFBA5",
...
export const blackMetalTheme: ThemeDefinition = {
  ...
  tokens: {
    ...
    fontFamilies: {
      ...baseFontFamilies,
      display: "Metaloxcide, serif",
      bold: "Metaloxcide, serif",
    },
    layout: baseLayout,
    shadows: {
      card: {
  ...
  assets: {
    logo: "/assets/images/black-metal-logo.png",
  },
};
