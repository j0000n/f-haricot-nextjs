  ...
  return (
    ...
    >
      ...
      <g id="Layer_1-2" data-name="Layer 1">
        <g>
          <rect className="cls-2" width="33.33" height="100" rx="8.12" ry="8.12" />
          <rect className="cls-2" x="66.66" width="33.33" height="100" rx="8.12" ry="8.12" />
          <path
            className="cls-1"
          ...
          />
          <g>
            <path className="cls-3" d="M5,50s0,.07,0,.1v-.2s0,.07,0,.1Z" />
            <path
              className="cls-3"
            ...
            />
            <rect className="cls-3" x="28.34" y="38.33" width="5" height="23.33" />
            <path
              className="cls-3"
            ...
            />
            <rect className="cls-3" x="33.34" y="61.66" width="33.33" height="5" />
            <path
              className="cls-3"
              d="M5.01,50.1v11.8c3.01,2.95,7.12,4.77,11.66,4.77h11.67v-5h-11.67c-6.41,0-11.61-5.17-11.66-11.57Z"
            />
            <rect className="cls-3" x="33.34" y="33.33" width="33.33" height="5" />
            <path className="cls-3" d="M0,50s0,.07,0,.1v-.2s0,.07,0,.1Z" />
            <path className="cls-3" d="M100,50s0-.06,0-.1v.2s0-.06,0-.1Z" />
            <path
              className="cls-3"
            ...
            />
            <path className="cls-3" d="M95,50s0-.06,0-.1v.2s0-.06,0-.1Z" />
            <rect className="cls-3" x="66.67" y="38.33" width="5" height="23.33" />
          </g>
        </g>
      </g>
    </svg>
